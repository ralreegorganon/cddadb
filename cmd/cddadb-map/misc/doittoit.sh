...
convert test.mpc -colorspace RGB -filter Lanczos2 -resize 32768x32768 +repage -colorspace sRGB -crop 256x256 -set filename:tile '%[fx:page.x/256]_%[fx:page.y/256]' +repage +adjoin '/Users/jj/Desktop/out/7/tile_%[filename:tile].png'

convert -colorspace RGB -filter Lanczos2 -resize 32768x32768 +repage test.png test.mpc
convert test.mpc -colorspace sRGB -crop 256x256 -set filename:tile '%[fx:page.x/256]_%[fx:page.y/256]' +repage +adjoin '/Users/jj/Desktop/out/7/tile_%[filename:tile].png'